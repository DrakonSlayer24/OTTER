...
void loadImage() { // pass the filepath string as a variable
	int channels;
	stbi_set_flip_vertically_on_load(true);

	image = stbi_load("2Texture.bmp", &width, &height, &channels, 0);
...
bool initGLFW() {
	...
	window = glfwCreateWindow(600, 800, "INFR2670", nullptr, nullptr);
...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// draw points 0-18 
		glDrawArrays(GL_TRIANGLES, 0, 1000);//36
